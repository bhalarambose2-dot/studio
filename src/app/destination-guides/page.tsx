...
const guides = [
  ...
  { name: 'Jodhpur, Rajasthan', description: 'The Blue City, famous for the Mehrangarh Fort and its blue-painted houses.', image: 'https://placehold.co/1080x1080.png', hint: 'jodhpur fort', price: '26,000' },
];
