...
const guides = [
  ...
  { name: 'Vrindavan, Uttar Pradesh', description: 'A holy town famous for its temples, including the stunning Prem Mandir.', image: 'https://placehold.co/1080x1080.png', hint: 'vrindavan temple', price: '20,000' },
];
