...
const guides = [
  ...
  { name: 'Rishikesh, Uttarakhand', description: 'The Yoga Capital of the World, known for its ashrams and adventure sports.', image: 'https://placehold.co/1080x1080.png', hint: 'rishikesh bridge', price: '18,000' },
