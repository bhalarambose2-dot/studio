...
import { Calendar as CalendarIcon, Users, Hotel, Plane, Search, MapPin, Car, Utensils, User, Globe, IndianRupee, CreditCard } from 'lucide-react';
              ...
              <Tabs defaultValue="trip" className="w-full">
                ...
                <TabsContent value="menu" className="pt-4">
                   <div className="container mx-auto">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-h-[400px] overflow-y-auto p-1">
                        {guides.map((guide) => (
