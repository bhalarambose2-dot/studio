...
export const popularDestinations = [
  ...
  { name: 'Udaipur, Rajasthan', image: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?q=80&w=2070&auto=format&fit=crop', hint: 'udaipur lake' },
  ...
  { name: 'Pushkar, Rajasthan', image: 'https://images.unsplash.com/photo-1626244101036-7c9b32e0e457?q=80&w=1974&auto=format&fit=crop', hint: 'pushkar lake' },
  { name: 'Mount Abu, Rajasthan', image: 'https://images.unsplash.com/photo-1628151970220-4354228c2c10?q=80&w=2070&auto=format&fit=crop', hint: 'mount abu lake' },
  { name: 'Bikaner, Rajasthan', image: 'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?q=80&w=1932&auto=format&fit=crop', hint: 'bikaner fort' },
  { name: 'Chittorgarh, Rajasthan', image: 'https://images.unsplash.com/photo-1603262110263-fb0112e7cc33?q=80&w=2071&auto=format&fit=crop', hint: 'chittorgarh fort' },
  { name: 'Ajmer, Rajasthan', image: 'https://images.unsplash.com/photo-1605649440411-9ef219324bc6?q=80&w=1974&auto=format&fit=crop', hint: 'ajmer dargah' },
