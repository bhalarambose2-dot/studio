...
export const popularDestinations = [
  { 
    ...
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-view-of-a-temple-in-india-40245-large.mp4',
    hint: 'jaipur palace', 
    price: 7500,
    rating: 4.9,
  ...
  { 
    ...
    city: 'Jodhpur', 
    image: images.hotelJaipur, 
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-a-fort-in-india-40246-large.mp4',
  ...
  { 
    ...
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-boating-on-a-lake-in-india-40247-large.mp4',
    hint: 'udaipur lake', 
    price: 8900,
    rating: 4.9,
    duration: '2 Days / 2 Nights',
  ...
  { 
    ...
    city: 'Jaisalmer', 
    image: images.hotelJaipur, 
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-camels-in-the-desert-at-sunset-40244-large.mp4',
  ...
  { 
    ...
    city: 'Pushkar', 
    image: images.hotelJaipur, 
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-people-on-the-streets-of-india-40243-large.mp4',
    hint: 'pushkar lake', 
    price: 5900,
    rating: 4.7,
    duration: '2 Days / 2 Nights',
