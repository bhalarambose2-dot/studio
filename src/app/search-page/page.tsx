      ...
      <div className="blue-header -mx-4 -mt-8 p-6 pb-12 rounded-b-[3rem] flex items-center gap-4 shadow-xl">
        ...
        <div>
          <h1 className="text-white text-2xl font-black italic uppercase tracking-tighter italic">
            {activeTab === 'hotel' ? 'Sahi Hotel Stay' : activeTab === 'bus' ? 'Sahi Bus Safar' : activeTab === 'bike' ? 'Sahi Bike Ride' : 'Sahi Taxi Safar'}
          </h1>
        ...
        <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden bg-white">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-4 bg-slate-50 p-1">
               <TabsTrigger value="hotel" className="rounded-2xl text-[9px] font-black uppercase tracking-tighter"><Hotel className="h-3 w-3 mr-1"/> Hotel</TabsTrigger>
               <TabsTrigger value="bus" className="rounded-2xl text-[9px] font-black uppercase tracking-tighter"><Bus className="h-3 w-3 mr-1"/> Bus</TabsTrigger>
               <TabsTrigger value="bike" className="rounded-2xl text-[9px] font-black uppercase tracking-tighter"><Bike className="h-3 w-3 mr-1"/> Bike</TabsTrigger>
               <TabsTrigger value="taxi" className="rounded-2xl text-[9px] font-black uppercase tracking-tighter"><Car className="h-3 w-3 mr-1"/> Taxi</TabsTrigger>
            </TabsList>
